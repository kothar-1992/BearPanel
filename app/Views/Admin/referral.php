                            ...
                            <tbody>
                                <?php foreach ($code as $c) : ?>
                                    <tr>
                                        ...
                                        <td><?= $c->created_by ?></td>
                                        <td>
 <button class="btn btn-dark btn-sm" data-user-id="<?php echo $c->id_reff ?>" onclick="deleteUserKey(this)" ><i class="bi bi-trash"></i></button>
...
function deleteUserKey(button) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            var api_url = `${base_url}/DELETEREFF.php?id=${userId}`;
            $.getJSON(api_url, {
                    userkey: userId 
                },
