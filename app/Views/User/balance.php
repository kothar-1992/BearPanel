    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <?= form_open('admin/transfer_balance')?>
                    <div class="row">
                        <div class="form-group mb-3">
                            ...
                            <select name="userlist" id="userlist" class="form-select col-lg-6 mb-3" required>
                                <option value="">
                                    Select an User
                                </option>
                            ...
                            <label for="amount" class="form-label col-lg-6 mb-3">
                                Amount
                            </label>
                            <input type="number" name="amount" id="amount" class="form-control col-lg-6 mb-3" min="0" step="0.01" required>
