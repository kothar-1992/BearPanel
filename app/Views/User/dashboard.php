...
<div class="form-group mb-2">
    <button type="button" class="btn btn-dark w-100" onclick="deleteAllUserKeys()"><i class="bi bi-trash-fill"></i> Delete All History Records</button>
</div>

                                        <?php endif; ?>
                                        <?php if($user->level == 1) : ?>
<div class="form-group mb-2">
    <button type="button" class="btn btn-dark w-100" onclick="deleteAllUserKeyss()"><i class="bi bi-trash-fill"></i> Delete All History Records</button>
</div>
<?php endif; ?>
...
<script src="https://code.jquery.com/jquery-3.1.0.min.js" integrity="sha256-cCueBR6CsyA4/9szpPfrX3s49M9vUU5BgtiJj06wt/s=" crossorigin="anonymous"></script>
  ...
  function deleteAllUserKeys() {
        Swal.fire({
            ...
            confirmButtonText: 'Yes, Delete All History'
        }).then((result) => {
            if (result.isConfirmed) {
                ...
                var api_url = `${base_url}/DeleteAllHistory`;
                $.getJSON(api_url, {
    ...
    function deleteAllUserKeyss() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var base_url = window.location.origin;
                var api_url = `${base_url}/ClearAllHistory`;
                $.getJSON(api_url, {
