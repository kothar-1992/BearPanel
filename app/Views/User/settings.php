  ...
  <div class="col-lg-12">
    ...
    <div class="card-header h6 p-3 bg-dark text-white">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-2">
                    <label for="password">N͟e͟w͟ P͟a͟s͟s͟w͟o͟r͟d͟</label>
                ...
                <div class="form-group mb-2">
                    <label for="password2">C͟o͟n͟f͟i͟r͟m͟ P͟a͟s͟s͟w͟o͟r͟d͟</label>
                ...
                <div class="form-group my-2">
                    ...
                    <button type="submit" class="btn btn-outline-primary rounded-pill">𝐂𝐡𝐚𝐧𝐠𝐞 𝐏𝐚𝐬𝐬𝐰𝐨𝐫𝐝</button>
                </div>
                <?= form_close() ?>
            </div>
        </div>
        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="fullname" id="fullname" class="form-control mt-2" placeholder="Justine Hacks" aria-describedby="help-fullname" value="<?= old('fullname') ?: ($user->fullname ?: '') ?>">
                    <?php if ($validation->hasError('fullname')) : ?>
                        <small id="help-fullname" class="text-danger"><?= $validation->getError('fullname') ?></small>
                    <?php endif; ?>
                </div>
   <div class="form-group my-2">
      <div class="card mb-3" style="background: linear-gradient(0.9turn, #6dd5ed, #ebe, #2193b0); 80rem;">
           <button type="submit" class="btn btn-dark">Update Account</button>
            ...
            <div class="card-body">
                ...
                <div class="form-group my-2">
                    ...
                    <button type="submit" class="btn btn-outline-dark rounded-pill">𝐔𝐩𝐝𝐚𝐭𝐞 𝐄𝐦𝐚𝐢𝐥</button>
                </div>
                <?= form_close() ?>
           </div>
        </div>
