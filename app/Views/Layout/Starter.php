...
<style>
 ...
 body{
            background-image: url("https://key-panel.site/Bear/uploads/images/bgjp.webp");
...
<body>
    ...
    <footer class="fixed-bottom bg-body border-top py-3 text-dark" style="background-image:url('https://bear.mod-key.click/uploads/images/bgjp.webp')">
        <div class="container">
            <small class="text-dark"><strong>&copy; <?= date('Y')-2 ?> - <?= date('Y') ?> | Bear Owner <?= BASE_NAME_FULL ?></strong></small>
        </div>
    </footer>
