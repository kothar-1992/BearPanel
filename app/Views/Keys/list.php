...
<div class="col-lg-12">
 ...
 <?php if (($user->level == 1) || ($user->level ==2)) : ?>
                       <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                    <i class="bi bi-file-arrow-down-fill"></i> Open Menu </a>
                  ...
                  <a class="dropdown-item" id="blur-out" data-bs-toggle="tooltip" data-bs-placement="top" title="Eye Protect">
                      ...
                      <i class="bi bi-eye-slash"></i>
                           ...
                           <?php if ($user->level == 1) : ?>
                            ...
                            <i class="bi bi-download"></i> Download All Key  
         ...
         <?php if (($user->level == 1) || ($user->level ==2)) : ?>    
               <a class="dropdown-item" href="<?= site_url('keys/alter')  ?>">
                            <i class="bi bi-trash-fill"></i> Del-Expired Keys
                            </a>
                           </li>
                            <?php endif; ?>
                     <li>
                    ...
                    <?php if ($user->level == 1) : ?>             
                 <a class="dropdown-item" href="<?= site_url('keys/price_detail')  ?>">
            ...
            columns: [{
                ...
                },
                {
                    ...
                    render: function(data, type, row, meta) {
                        ...
                        var btnEdits = `<a href="${window.location.origin}/Bear/keys/${row.id}" class="btn btn-outline-dark btn-sm"
    ...
    function resetUserKey(keys) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                var api_url = `${base_url}/Bear/keys/reset`;
                $.getJSON(api_url, {
                        userkey: keys,
                        reset: 1
                    },
